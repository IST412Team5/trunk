...
public class StudentConfigTab extends JPanel {
            ...
            try {
                while ((line = reader.readLine()) != null) {
                    ...
                    if (line.trim().length() > 2) {
                        ...
                        jcb.setSelected(studList.contains(sArr[1]));
    ...
    ActionListener alSave = new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            ...
            // now save it all
            Utility.writeFile(Utility.getConfigItem("ConfigureBatch", "C:\\java\\src\\configbatch.txt"), sb.toString());
    ...
    private List<String> getStudents() {
        ...
        String file = Utility.getConfigItem("ConfigureBatch", "C:\\java\\src\\configbatch.txt");
        try {
            BufferedReader reader = new BufferedReader(new FileReader(file));
            String ls = System.getProperty("line.separator");
            String line = "";
    ...
    private String getStudentFile() {
        return Utility.getConfigItem("StudentFilePath", "C:\\java\\students.txt");
    }
}
